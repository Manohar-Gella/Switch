...
// push()
// to push new element into the last of array
function pushExample(arr, element) {
  ...
  // shift()
  // to remoe the first element from the array
  ...
  // unshift()
  // to push a new element into the start of array
